...
public class Follower extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.FollowerRecord> {
	...
	private static final long serialVersionUID = -1111625510;
	...
	/**
	 * The column <code>public.Follower.follower_id</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.FollowerRecord, java.lang.Long> FOLLOWER_ID = createField("follower_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
	...
	public java.util.List<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>>asList(tech.codingclub.helix.Keys.FOLLOWER_FOLLOWER_ID_USER_ID_KEY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>>asList(tech.codingclub.helix.Keys.FOLLOWER__USER_ID, tech.codingclub.helix.Keys.FOLLOWER__FOLLOWER_ID);
	}

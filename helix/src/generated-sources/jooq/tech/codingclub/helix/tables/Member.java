...
public class Member extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.MemberRecord> {
	...
	private static final long serialVersionUID = -967338414;
	 ...
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>public.Member.email</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> EMAIL = createField("email", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

	/**
	 * The column <code>public.Member.role</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> ROLE = createField("role", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>public.Member.password</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> PASSWORD = createField("password", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>public.Member.image</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> IMAGE = createField("image", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>public.Member.token</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> TOKEN = createField("token", org.jooq.impl.SQLDataType.VARCHAR, this, "");
	...
	public org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord> getPrimaryKey() {
		return tech.codingclub.helix.Keys.PRIMARY_ID;
	}
	...
	public java.util.List<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord>>asList(tech.codingclub.helix.Keys.PRIMARY_ID);
	}

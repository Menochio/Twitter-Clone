    ...
    <div class="row  d-flex align-items-center justify-content-center" id="login-page">
      <div class="col-lg-4 col-sm-12 col-xs-12 col-md-6" id="content"> <span class="text-center">
        ...
        <div class="form-group d-block mx-auto">
          ...
          <input type="text" class="form-control" name="userName" id="user-name" placeholder="Enter your Name" required>
            ...
            <input type="password" class="form-control" name="userPW" id="user-password" placeholder="Create your password">
            <div class="text-center">
              <button type="button" class="btn btn-primary mt-3" id="loginBtn">Sign Up</button>
            </div>

    ...
    <body>
                        ...
                        <div class="layout_content">
                            <div class="feed">
                                <div class="feed_header">
                                    <h1 class="feed_title">User Recommendations</h1>
                                </div>
                                          ...
                                          <div class="joke">
                                              <div class="joke_wrapper">
                                                  ...
                                                  <c:if test="${ member.is_followed}">
                                                      <button style="margin-top: 12px;" member-id = "${member.id}" class="follow-member followed-member" type="submit" tabindex="0">
        ...
        <script type="text/javascript">
            $(".follow-member").click(function (event) {
                ...
                var button = this;
                var isFollowed = $(button).hasClass("followed-member");
                if(isFollowed === true){
                    $.ajax({
                        type: "POST",
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/user/follow-member/"+data,
                        success: function (response) {
                            if (!!response) {
                                $(button).addClass("followed-member");
